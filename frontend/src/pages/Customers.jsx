        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t('aboHolder')}</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t('aboStart')}</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">{t('aboEnd')}</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredCustomers.map((customer) => (
              <tr key={customer.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">{customer.abo_start || '-'}</td>
                <td className="px-6 py-4 whitespace-nowrap">{customer.abo_end || '-'}</td>
                <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="flex items-center gap-2">
                  <input
                    ...
                    className="w-4 h-4"
                  />
                  <span className="text-sm font-medium">{t('aboHolder')}</span>
                </label>
              </div>
              ...
              {formData.is_abo_holder && (
                <>
                  <div>
                    <label className="block text-sm font-medium mb-1">{t('aboStart')}</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">{t('aboEnd')}</label>
                    <input
                      type="date"
